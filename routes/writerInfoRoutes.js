...
const { writerInfo, writerInfoUpdate, writerBookCreate, writerTotalBook, writerBookUpdate, writerBookDetele } = require('../controllers/writerInfoControllers/writerInfoControllers');
...
router.delete('/writer_book_delete/:id', writerBookDetele);
